...
public class ModZhCnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModItems.HELLALLOY_BOOTS.get(), "§a幽冥合金长靴");
        ...
        add(ModItems.STEEL_AXE.get(), "精钢斧");
        add(ModItems.STEEL_HOE.get(), "精钢锄");
        add(ModItems.STEEL_PICKAXE.get(), "精钢镐");
        add(ModItems.STEEL_SHOVEL.get(), "精钢铲");
        add(ModItems.STEEL_SWORD.get(), "精钢剑");
        add(ModItems.STEEL_HELMET.get(), "精钢头盔");
        ...
        add(ModBlocks.HELLWOOD_LOG.get(), "幽染原木");
        add(ModBlocks.HELLWOOD_WOOD.get(), "幽染木");
        add(ModBlocks.STRIPPED_HELLWOOD_LOG.get(), "去皮幽染原木");
        add(ModBlocks.STRIPPED_HELLWOOD_WOOD.get(), "去皮幽染木");
        add(ModBlocks.HELLWOOD_PLANKS.get(), "幽染木板");
        add(ModBlocks.HELLWOOD_LEAVES.get(), "幽染树叶");
        add(ModBlocks.HELLWOOD_SAPLING.get(), "幽染树苗");
        add(ModBlocks.HELLWOOD_BUTTON.get(), "幽染木按钮");
        add(ModBlocks.HELLWOOD_FENCE.get(), "幽染木栅栏");
        add(ModBlocks.HELLWOOD_FENCE_GATE.get(), "幽染木栅栏门");
        add(ModBlocks.HELLWOOD_DOOR.get(), "幽染木门");
        add(ModBlocks.HELLWOOD_TRAPDOOR.get(), "幽染木活板门");
        add(ModBlocks.HELLWOOD_PRESSURE_PLATE.get(), "幽染木压力板");
        add(ModBlocks.HELLWOOD_STAIRS.get(), "幽染木楼梯");
        add(ModBlocks.HELLWOOD_SLAB.get(), "幽染木台阶");
